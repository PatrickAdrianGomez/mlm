        ...
        <tr>
            <td style="padding: 20px 0 0 0;">
                <table class="buttonwrapper" bgcolor="#3b0000"
                    ...
                    <tr>
                        <td class="button" height="45">
                            <a href="http://11.vps.confiared.com:16679">Visítanos</a>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="padding: 20px 0 0 0;">
                <table class="buttonwrapper" bgcolor="#3b0000"
                    ...
                    <tr>
                        <td class="button" height="45">
                            <a href="http://11.vps.confiared.com:16679/purchases/52">Controla tu Pedido</a>
                        </td>
                    </tr>
                </table>
            </td>
                                ...
                                <table width="70" align="left" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td height="70" style="padding:0 20px 20px 0;">
                                            <a href="http://11.vps.confiared.com:16679">
                                                <img class="fix"
