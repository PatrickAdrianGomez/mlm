...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["adm-adm-module"], {
    ...
    function () {
      ...
      _createClass(AgendaPedidoComponent, [{
        ...
        value: function enviar() {
          ...
          this.pedido.geolocalizacion = 'aaaaa';
          this.pedido.fechaHora = new Date();
          this.pedido.usuario = '111';
          this.pedido.sucursal = '222';
          this.pedido.estadoActual = 1;
          this.pedido.ubicacionActual = 'bbb';
          console.log(this.pedido);
          this.connexion.addObject('pedido', this.pedido).subscribe(function (regis) {
    ...
    function () {
      ...
      _createClass(CompraProductoComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.cnx.get_data('products').subscribe(function (myProds) {
            console.log(myProds);
    ...
    function () {
      ...
      _createClass(FichaPedidoComponent, [{
        ...
        value: function ngOnInit() {
          ...
          console.log(this.urlGlobal + this.urlImage);
          this.ruta.paramMap.subscribe(function (params) {
            _this34.estadoActual = params.get('estado');

            _this34.cambiaTitulo(params.get('estado'));

            _this34.cargaFichas(params.get('estado'));
          });
        ...
        value: function cargaFichas(estado) {
          ...
          this.connexion.get_dataWithParamsNoAuth('pedido', '?estadoActual=' + estado).subscribe(function (resp) {
      ...
      _createClass(InvitationComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.connexion.get_data('location').subscribe(function (reslo) {
            ...
            console.log(_this40.listSucursal);
          }, function (error) {
            console.log('Hubo un problema al cargar datos. ' + error);
          });
          this.connexion.get_data('typecontext').subscribe(function (reslo) {
        ...
        value: function updateSelectSucursal(index) {
          this.listSucursal = this.ListLOC.filter(function (LOC) {
            return LOC.owner == index;
          });
        }
      }, {
  ...
  function srcAppAdmViewsProductsLoadProductsLoadComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_models_schema__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/models/schema */
    "./src/app/models/schema.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function ProductsLoadComponent(connexion) {
      ...
      _createClass(ProductsLoadComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.producto = new src_app_models_schema__WEBPACK_IMPORTED_MODULE_2__["Products"]();
