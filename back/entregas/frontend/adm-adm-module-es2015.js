...
let AgendaPedidoComponent = class AgendaPedidoComponent {
    ...
    enviar() {
        ...
        this.connexion.addObject('pedido', this.pedido).subscribe(regis => {
...
AgendaPedidoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./agenda-pedido.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/adm/views/agenda-pedido/agenda-pedido.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./agenda-pedido.component.css */ "./src/app/adm/views/agenda-pedido/agenda-pedido.component.css")).default]
    })
...
let CompraProductoComponent = class CompraProductoComponent {
    ...
    ngOnInit() {
        this.cnx.get_data('products').subscribe(myProds => {
            console.log(myProds);
    ...
    comprando(item) {
        ...
        if (this.compra.length == 0) {
            this.compra.push({ id: item._id, nombre: item.acronym, cantidad: 1 });
        }
        else {
            let nuevaCantidad = 1;
            let ubicacion = -1;
            for (let i = 0; i < this.compra.length; i++) {
                if (this.compra[i].id == item._id) {
                    ...
                    this.compra[i] = { id: item._id, nombre: item.acronym, cantidad: nuevaCantidad };
                    ubicacion = i;
                    break;
                }
            }
            if (ubicacion == -1) {
                this.compra.push({ id: item._id, nombre: item.acronym, cantidad: nuevaCantidad });
            }
        }
    }
    quitar(id) {
        for (let i = 0; i < this.compra.length; i++) {
            if (this.compra[i].id == id) {
                ...
                if (nuevaCantidad <= 0) {
                    ...
                    this.compra[i] = { id: this.compra[i].id, nombre: this.compra[i].nombre, cantidad: nuevaCantidad };
                }
                break;
            }
        }
...
CompraProductoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./compra-producto.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/adm/views/compra-producto/compra-producto.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./compra-producto.component.css */ "./src/app/adm/views/compra-producto/compra-producto.component.css")).default]
    })
...
let FichaPedidoComponent = class FichaPedidoComponent {
    ...
    ngOnInit() {
        ...
        this.ruta.paramMap.subscribe((params) => {
            ...
            this.cambiaTitulo(params.get('estado'));
            this.cargaFichas(params.get('estado'));
        });
    ...
    cargaFichas(estado) {
        this.connexion.get_dataWithParamsNoAuth('pedido', '?estadoActual=' + estado).subscribe(resp => {
...
FichaPedidoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./ficha-pedido.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/adm/views/ficha-pedido/ficha-pedido.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./ficha-pedido.component.css */ "./src/app/adm/views/ficha-pedido/ficha-pedido.component.css")).default]
    })
...
let ListaAgendadosComponent = class ListaAgendadosComponent {
    ...
    obtenerDatos(state, id) {
        console.log(state, id);
        this.isLoading = true;
        this.cnx.get_data('pedido').subscribe(myProds => {
            console.log(myProds);
            this.rows = myProds;
            setTimeout(() => {
                this.isLoading = false;
...
ListaAgendadosComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./lista-agendados.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/adm/views/lista-agendados/lista-agendados.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./lista-agendados.component.css */ "./src/app/adm/views/lista-agendados/lista-agendados.component.css")).default]
    })
...
ProductListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./product-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/adm/views/product-list/product-list.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./product-list.component.css */ "./src/app/adm/views/product-list/product-list.component.css")).default]
    })
...
ProductsLoadComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./products-load.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/adm/views/products-load/products-load.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./products-load.component.css */ "./src/app/adm/views/products-load/products-load.component.css")).default]
    })
